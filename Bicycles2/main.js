    ...
    const updateDashboard = function(predictionsData) {
        ...
        predictionsData.forEach(function(prediction, index) {
            ...
            if (prediction.class === "Bicycle") {
                ...
                element = $("<img>").attr({
                    id: elementId,
                    src: "../BICYCLES2/image/BicycleSpecification3.jpg", // Replace with the actual image source
                    alt: "Bicycle Image"
                });
                ...
                element = $("<img>").attr({
                    id: elementId,
                    src: "../BICYCLES2/image/Bicycle Specification.jpg", // Replace with the actual image source
                    alt: "Bicycle Image"
                });
